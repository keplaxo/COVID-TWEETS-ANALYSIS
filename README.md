...
An analysis of tweets about the COVID_19 pandemic. 
...
* Activate the environment using the following command in a terminal window:
  ...
  * Windows: `activate covid-tweets-analyis`
  * Linux, OS X: `source activate covid-tweets-analyis`
...
* Deactivate the environment using the following command in a terminal window:
  ...
  * Windows: `deactivate covid-tweets-analyis`
  * Linux, OS X: `source deactivate covid-tweets-analyis`
               
* Delete the environment using the command (can't be undone):

  * `conda remove --name covid-tweets-analyis --all`
...
│   └── covidtweetsanalyis       <- Example python package - place shared code in such a package
...
└── tests                    <- Test cases (named after module)
    ...
    └── covidtweetsanalyis       <- covidtweetsanalyis tests
